...
async function generateJSON(prompt: string, fallbackData: any): Promise<any> {
  if (!ai) {
...
async function generateMultimodalJSON(prompt: string, fileBuffer: Buffer, mimeType: string, fallbackData: any): Promise<any> {
  if (!ai) {
...
export async function generateBlueprint(idea: any, rules: any): Promise<any> {
...
export async function generatePitchAndSlides(idea: any): Promise<any> {
